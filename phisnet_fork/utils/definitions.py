...
orbital_definitions = {
    'fulvene_minimal_basis': {
        ...
        7: np.array([0, 0, 1])      # N has 1s, 2s & 2p orbital <-- ADD THIS LINE
    },
    'fulvene_cc-pVDZ': {
...
orbital_conventions = {
    ...
    'molcas_ANO-VDZP': Namespace(
        ...
        global_order_map={
            'H': [0, 1, 2, 3, 4],
            'C': [0, 1, 2, 3, 5, 7, 4, 6, 8, 9, 10, 11, 12, 13],
            'N': [0, 1, 2, 3, 5, 7, 4, 6, 8, 9, 10, 11, 12, 13],
        },
    )
}
...
reverse_orbital_conventions = {
    ...
    'molcas_ANO-VDZP': Namespace(
        ...
        global_order_map={
            'H': [0, 1, 2, 3, 4],
            'C': [0, 1, 2, 3, 6, 4, 7, 5, 8, 9, 10, 11, 12, 13],
            'N': [0, 1, 2, 3, 6, 4, 7, 5, 8, 9, 10, 11, 12, 13],
        },
    )
}